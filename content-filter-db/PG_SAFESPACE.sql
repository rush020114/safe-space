...
CREATE TABLE POST_IMG(
	IMG_NUM SERIAL PRIMARY KEY                 -- 이미지번호
...
-- 댓글
CREATE TABLE CMT (
	CMT_ID SERIAL PRIMARY KEY                                    -- 댓글 번호
...
-- 신고
CREATE TABLE REPORT (
	REPORT_ID SERIAL PRIMARY KEY                            -- 신고 아이디
...
CREATE TABLE SANCTION (
	SANCTION_ID SERIAL PRIMARY KEY                            -- 제재 아이디
	...
	, END_DATE TIMESTAMP                                      -- 제재 만료일 (영구 제재 NULL)
	, MEM_ID INT NOT NULL
